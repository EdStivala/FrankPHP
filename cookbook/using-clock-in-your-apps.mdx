...
description: "A practical cookbook for handling dates, times, timezones, and UTC storage with Frank\\Core\\Clock in FrankPHP."
---

# Using Clock in Your Apps

FrankPHP v1.3.0 added `Frank\Core\Clock`, a small framework-owned utility that gives every application the same date/time contract:
...
```php
use Frank\Core\Clock;
use Frank\Services\ServiceResult;
