...
At the start of every session, paste both `CODEBASE.md` and `MYAPP.md` into the conversation. The AI has full context from that point forward.
...
- [AI Context Briefing](/features/ai-context-briefing) — how CODEBASE.md and MYAPP.md work together and why the separation matters
